...
function buildExportForAiMarkdown(referenceDate = getDnaResultsReferenceDate()) {
  ...
  return [
    ...
    '- Analyze the supplied trading data and provide an overall assessment, proven strengths, proven weaknesses only when supported by the data, important patterns, and practical next steps.',
    '- Coach profitability first.',
    '- Judge profitability using Net P/L, Profit Factor, consistency, and supporting metrics together.',
    '- Use realized trading results and realized closed-trade losses rather than theoretical risk assumptions.',
    '- Never invent a weakness just because every trader is expected to have one.',
    '- Do not manufacture weaknesses when the data does not prove them.',
    '- Distinguish clearly between statistically supported findings and observations based on small samples.',
    '- Do not impose generic textbook trading rules when the trader\'s actual results do not support them.',
